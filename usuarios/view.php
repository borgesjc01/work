...
$diccionario = array(
			...
			'form_actions'=>array('SET'=>'/mvc/'.MODULO.SET_USER.'/',
...
function retornar_vista($vista,$data=array()){
	...
	$html=render_dinamic_data($html,$diccionario['links_menu']);$html=render_dinamic_data($html,$data);
// render {mensaje} 
	if(array_key_exists('nombre',$data)&&
       ...
       $mensaje='Editar usuario '.$data['nombre'].' '.$data['apellido'];
			...
			else{$mensaje = 'Datos del usuario:';}
}
